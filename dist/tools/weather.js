...
exports.weatherToolSchema = void 0;
exports.handleWeatherTool = handleWeatherTool;
// ---------------------------------------------------------------------------
// Tool schema definition (used when registering with MCP server)
// ---------------------------------------------------------------------------
exports.weatherToolSchema = {
    name: 'weather_current',
    description: '[DEMO] Get the current weather for a city. ' +
...
// Handler
// ---------------------------------------------------------------------------
async function handleWeatherTool(args, _entitlement) {
...
function getMockedWeather(city, units) {
